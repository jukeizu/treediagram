...
func (*Preference) Descriptor() ([]byte, []int) {
	return fileDescriptor_user_97a13a05e7539e08, []int{0}
}
...
func (*PreferenceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_user_97a13a05e7539e08, []int{1}
}
...
func (*PreferenceReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_user_97a13a05e7539e08, []int{2}
}
...
func (*SetServerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_user_97a13a05e7539e08, []int{3}
}
...
func init() {
	proto.RegisterType((*Preference)(nil), "user.Preference")
	proto.RegisterType((*PreferenceRequest)(nil), "user.PreferenceRequest")
	proto.RegisterType((*PreferenceReply)(nil), "user.PreferenceReply")
	proto.RegisterType((*SetServerRequest)(nil), "user.SetServerRequest")
}
...
func (c *userClient) Preference(ctx context.Context, in *PreferenceRequest, opts ...grpc.CallOption) (*PreferenceReply, error) {
	...
	err := c.cc.Invoke(ctx, "/user.User/Preference", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) SetServer(ctx context.Context, in *SetServerRequest, opts ...grpc.CallOption) (*PreferenceReply, error) {
	out := new(PreferenceReply)
	err := c.cc.Invoke(ctx, "/user.User/SetServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_Preference_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.User/Preference",
	}
...
func _User_SetServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.User/SetServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func init() { proto.RegisterFile("user.proto", fileDescriptor_user_97a13a05e7539e08) }

var fileDescriptor_user_97a13a05e7539e08 = []byte{
	// 192 bytes of a gzipped FileDescriptorProto
	,
}
